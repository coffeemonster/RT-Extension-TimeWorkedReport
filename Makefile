# This Makefile is for the RT::Extension::TimeWorkedReport extension to perl.
#
...
#     AUTHOR => [q[-2012 Fran Fabrizio <fabrizio-at-uab-dot-edu>]]
#     BUILD_REQUIRES => { ExtUtils::MakeMaker=>q[6.42] }
#     CONFIGURE_REQUIRES => {  }
#     DISTNAME => q[RT-Extension-TimeWorkedReport]
#     LICENSE => q[gpl]
#     MIN_PERL_VERSION => q[5.006]
#     NAME => q[RT::Extension::TimeWorkedReport]
#     NO_META => q[1]
#     PREREQ_PM => { ExtUtils::MakeMaker=>q[6.42] }
#     VERSION => q[1.02]
#     VERSION_FROM => q[lib/RT/Extension/TimeWorkedReport.pm]
...
NAME_SYM = RT_Extension_TimeWorkedReport
VERSION = 1.02
...
MAN3EXT = 3pm
INSTALLDIRS = site
INSTALL_BASE = /home/alister/perl5
DESTDIR = 
PREFIX = $(INSTALL_BASE)
...
MAKEMAKER   = /home/alister/perl5/lib/perl5/ExtUtils/MakeMaker.pm
MM_VERSION  = 6.62
MM_REVISION = 66200
...
MAKE = make
FULLEXT = RT/Extension/TimeWorkedReport
BASEEXT = TimeWorkedReport
PARENT_NAME = RT::Extension
DLBASE = $(BASEEXT)
VERSION_FROM = lib/RT/Extension/TimeWorkedReport.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/RT/Extension/TimeWorkedReport.pm
...
TO_INST_PM = lib/RT/Extension/TimeWorkedReport.pm

PM_TO_BLIB = lib/RT/Extension/TimeWorkedReport.pm \
	blib/lib/RT/Extension/TimeWorkedReport.pm
...
DISTNAME = RT-Extension-TimeWorkedReport
DISTVNAME = RT-Extension-TimeWorkedReport-1.02
...
manifypods : pure_all  \
	lib/RT/Extension/TimeWorkedReport.pm
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/RT/Extension/TimeWorkedReport.pm $(INST_MAN3DIR)/RT::Extension::TimeWorkedReport.$(MAN3EXT) 
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <AUTHOR>-2012 Fran Fabrizio &lt;fabrizio-at-uab-dot-edu&gt;</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/RT/Extension/TimeWorkedReport.pm blib/lib/RT/Extension/TimeWorkedReport.pm 
